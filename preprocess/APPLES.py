# -*- coding: utf-8 -*-
"""
APPLES Dataset Preprocessing Module

This module handles the preprocessing of the APPLES polysomnography (PSG) dataset for the LPSGM project.
...
This preprocessing step is crucial for preparing the APPLES dataset to be compatible with the LPSGM model's 
input requirements.
"""
...
if __name__ == "__main__":
    print('='*30, 'PREPROCESSING APPLES DATASET', '='*30)

    # Source directory containing raw APPLES PSG EDF and annotation files
    src_root = r"/nvme1/denggf/PSG_datasets/public_datasets/APPLES/files/polysomnography/"
    # Destination directory for saving processed data
    dst_root = r"./data/APPLES/"
