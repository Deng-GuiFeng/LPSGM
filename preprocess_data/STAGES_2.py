...
def process_recording(sub_id):
    ...
    # check timestamp, add 1 to day if it the 1st timestamp less than the start time
...
if __name__ == "__main__":
    ...
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/STAGES-GSDV/"
    ...
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/STAGES-MSTR/"
    shutil.rmtree(dst_root, ignore_errors=True)
    SUB_REMOVE = []
    run(100)
    formatting_check(dst_root)
    ...
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/STAGES-GSBB/"
    shutil.rmtree(dst_root, ignore_errors=True)
    SUB_REMOVE = []
    run(100)
    formatting_check(dst_root)
    ...
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/STAGES-GSLH/"
    shutil.rmtree(dst_root, ignore_errors=True)
    ...
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/STAGES-GSSA/"
    shutil.rmtree(dst_root, ignore_errors=True)
    SUB_REMOVE = []
    run(100)
    formatting_check(dst_root)
    ...
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/STAGES-GSSW/"
    shutil.rmtree(dst_root, ignore_errors=True)
    SUB_REMOVE = []
    run(100)
    formatting_check(dst_root)
    ...
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/STAGES-MSMI/"
    shutil.rmtree(dst_root, ignore_errors=True)
    SUB_REMOVE = []
    run(100)
    formatting_check(dst_root)
    ...
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/STAGES-MSNF/"
    shutil.rmtree(dst_root, ignore_errors=True)
    SUB_REMOVE = []
    run(100)
    formatting_check(dst_root)
    ...
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/STAGES-MSQW/"
    shutil.rmtree(dst_root, ignore_errors=True)
    SUB_REMOVE = []
    run(100)
    formatting_check(dst_root)
    ...
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/STAGES-MSTH/"
    shutil.rmtree(dst_root, ignore_errors=True)
    SUB_REMOVE = []
    run(100)
    formatting_check(dst_root)
    ...
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/STAGES-STLK/"
    shutil.rmtree(dst_root, ignore_errors=True)
    SUB_REMOVE = []
    run(100)
    formatting_check(dst_root)
