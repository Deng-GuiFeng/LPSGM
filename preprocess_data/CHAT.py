...
if __name__ == "__main__":
    src_root = r"/nvme1/denggf/PSG_datasets/public_datasets/chat/polysomnography/"
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/CHAT/"
    ...
    channel_id = {
        'F3-M2': 0, 'F3-A2': 0, 'F3': 0, 
        'F4-M1': 1, 'F4-A1': 1, 'F4': 1, 
        'C3-M2': 2, 'C3-A2': 2, 'C3': 2, 
        'C4-M1': 3, 'C4-A1': 3, 'C4': 3, 
        'O1-M2': 4, 'O1-A2': 4, 'O1': 4, 
        'O2-M1': 5, 'O2-A1': 5, 'O2': 5, 
        'E1': 6, 'E2': 7, 
        'M1': -1, 'M2': -2,
    }
