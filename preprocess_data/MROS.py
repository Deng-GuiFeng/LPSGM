...
if __name__ == "__main__":
    src_root = r"/nvme1/denggf/PSG_datasets/public_datasets/mros/polysomnography/"
    dst_root = r"/nvme1/denggf/SleepStagingProcessedData/MROS/"
    shutil.rmtree(dst_root, ignore_errors=True)

    # SUB_REMOVE = ["mros-visit1-aa2180", "mros-visit1-aa4156", "mros-visit1-aa2159", "mros-visit1-aa2931"]
